...
export class ConfigStateService {
  private readonly abpConfigService = inject(AbpApplicationConfigurationService);
  private readonly abpApplicationLocalizationService = inject(AbpApplicationLocalizationService);
